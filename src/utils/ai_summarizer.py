...
4. TRANSACTION TYPE: Choose exactly one from: "Equity Funding Round", "Acquisition", "Merger", "IPO", "Strategic Partnership", "Internal Investment", "Contract/Award", "Fund Raise". "Equity Funding Round" = company raises equity capital (Seed through late-stage VC, PE growth equity). "Acquisition" = one company buys another outright. "Merger" = two companies combine. "IPO" = company goes public. "Strategic Partnership" = joint venture, teaming agreement, licensing deal, or non-equity collaboration. "Internal Investment" = company invests in itself from its own balance sheet (facilities, R&D capex). "Contract/Award" = government contract, SBIR/STTR award, government grant. "Fund Raise" = VC/PE fund raising LP capital. Return as a single string.
